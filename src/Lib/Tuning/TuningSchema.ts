...
export const TUNING_SCHEMA: readonly TuningFieldMeta[] = [
  ...
  { key: 'store_weapon_slots', label: 'ショップ武器枠数', category: 'economy', defaultValue: 4, control: { type: 'number', min: 1, max: 10, step: 1 } },
  { key: 'store_relic_slots', label: 'ショップレリック枠数', category: 'economy', defaultValue: 2, control: { type: 'number', min: 1, max: 10, step: 1 } },
  { key: 'store_potion_slots', label: 'ショップポーション枠数', category: 'economy', defaultValue: 2, control: { type: 'number', min: 1, max: 10, step: 1 } },
