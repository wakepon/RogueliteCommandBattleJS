...
export function NextStagePreview({ seed, currentStage, offset = 1, label = 'Next' }: NextStagePreviewProps) {
  ...
  return (
    <div className="w-28 bg-gray-800/90 border border-gray-500 rounded-lg p-1.5">
      {/* ヘッダー */}
      <div className="text-[10px] text-gray-400 mb-1 text-center font-bold">
        {label}
      </div>

      {isNextEvent ? (
        // イベントステージの場合: 3つの選択肢を表示
